...
<html>
    ...
    <body>
        <form method="post" action="https://sandbox.payhere.lk/pay/checkout">   
            ...
            <input type="text" name="items"   value="<?php echo $_SESSION['name']?>"><br>
            <input type="hidden" name="currency"  value="LKR">
            <input type="text" name="amount"  value="<?php echo $_SESSION['amount']?>">  
            <br><br><h1>Customer Details</h1><br>
            <input type="text" name="first_name" placeholder="Enter Your Name..">
            <input type="hidden" name="last_name" placeholder="Enter Your Last Name.." ><br>
            <input type="text" name="email" placeholder="Enter Your Email.." >
            <input type="text" name="phone" placeholder="Enter Your Telephone No.." ><br>
