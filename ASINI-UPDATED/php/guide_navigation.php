...
<html>
    ...
    <body>        
        ...
        <div id="myDIV">
            ...
            <a href="aboutus_guide.php"><div class="txt"><Button class=" btn">About</button></div></a>
            <a href="contact_guide_page.php"><div class="txt"><Button class=" btn">Contact</button></div></a>
            <a href="guide_view_profile.php"><div class="txt"><Button class=" btn">View Profile</button></div></a>
