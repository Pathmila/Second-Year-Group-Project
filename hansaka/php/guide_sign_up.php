...
//insert data to guide  table
 ...
 //insert in to account availabilty table
				$insertguideavailability = "INSERT INTO guideavailability(uid,avail) values ('".$gid."','".$availability."')";
...
<!-- guide availability -->     
                   ...
                   <div class='row'>
						...
						<div class='col-50'>
							<h3>Availability:</h3>
                                <input  type="radio" name="avail" value="yes">
                                     <label class="label_1">Yes</label><br>
                                <input type="radio" name="avail" value="no">
